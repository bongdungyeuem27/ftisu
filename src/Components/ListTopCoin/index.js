...
import { topDailyVolumeData, getCoinDataApiByMarket } from "../../api/crypto";
              ...
              return (
                <tr key={key}>
                  ...
                  <td style={{ textAlign: "right" }}>
                    <span className={value.RAW[fiatObject.value].CHANGEDAY<0?"hzgCfk number-negative":"hzgCfk number-positive"}>
                      <span className="icon-Caret-down" />
                      {(Math.round(value.RAW[fiatObject.value].CHANGEDAY/value.RAW[fiatObject.value].OPEN24HOUR*100)/100).toLocaleString()}%
                    </span>
                  </td>
                  <td style={{ textAlign: "right" }}>
                  ...
                  <td style={{ textAlign: "right" }}>
                    <div className="sc-16r8icm-0 j3nwcd-0 cRcnjD">
                      ...
                      >
                        ...
                        >
                          {fiatObject?.sign}
                          {Math.round(value.RAW[fiatObject.value].TOTALVOLUME24HTO).toLocaleString()}
                      ...
                      <div data-nosnippet="true">
                        <p
                          ...
                          className="sc-1eb5slv-0 etpvrL"
                        >
                          {Math.round(value.RAW[fiatObject.value].TOTALVOLUME24H).toString().toLocaleString()} {value.CoinInfo.Name}
                        </p>
                      </div>
                    </div>
                  </td>
                  ...
                  <td style={{ textAlign: "right" }}>
                    ...
                    >
                      <img
                        src={`https://images.cryptocompare.com/sparkchart/${value.CoinInfo.Name}/${fiatObject.value}/latest.png?ts=${new Date().getTime()}`}
        ...
        <>
          ...
          <div className="sc-16r8icm-0 sc-4r7b5t-0 gJbsQH my-container">
            <p color="text" fontSize={1} className="sc-1eb5slv-0 hykWbK">
              {keywords?._showing} {(page-1)*itemsInOnePage+1} - {(page-1)*itemsInOnePage + items.length}
            </p>
